          ...
          >
            <div className="text-[#74767e] lg:pr-4 w-full lg:w-auto">
              <ul className="flex flex-col lg:flex-row gap-4 text-base font-medium w-full lg:w-auto">
                <li
                  className={clsx(
                    "z-50 flex cursor-pointer items-center relative h-9 justify-center rounded-full bg-green-500 text-white font-bold text-center hover:bg-green-400",
                    {
                      "ml-auto": !menuOpen,
                      "sm:px-6": !menuOpen,
                    }
                ...
                >
                  <Link href="/login" className="z-50 mx-5 w-full">
                    Login
                  </Link>
                </li>
                <li
                ...
                >
                  <Link href="/create-account" className="z-50 w-full">
                    Create an Account
                  </Link>
                </li>
              </ul>
