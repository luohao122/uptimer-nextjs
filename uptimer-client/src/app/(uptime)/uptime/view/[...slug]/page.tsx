        ...
        <div className="m-auto px-6 relative min-h-screen xl:container">
          <div className="flex h-32 items-center justify-between">
            <div className="flex flex-col">
              ...
              <a
                className="text-base font-normal cursor-pointer text-[#1e8dee] hover:underline"
                target="_blank"
                href={monitor.url}
              >
                {monitor.url}
            ...
            <div className="flex flex-col gap-y-2">
              <div
                className={clsx(
                  "px-4 py-2 text-sm font-semibold text-white rounded",
                  {
          ...
          <div className="my-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex flex-col border h-48 justify-center">
                <span className="text-[20px] font-bold text-[#333333] text-center">
                  Latest Response
                </span>
                <span className="text-[18px] text-[#333333] text-center">
