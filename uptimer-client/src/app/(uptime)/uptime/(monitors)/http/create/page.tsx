...
const CreateHttpMonitor: FC = (): ReactElement => {
  ...
  const handleSetActive = useCallback(
    (event: string) => {
      setMonitorInfo((prev) => ({ ...prev, active: event === "Running" }));
    },
    [setMonitorInfo]
  );
  ...
  const handleHeaderChange = useCallback(
    (event: ChangeEvent) => {
      ...
      setMonitorInfo((prev) => ({ ...prev, headers: value }));
    },
    [setMonitorInfo]
  );
  ...
  const handleBodyChange = useCallback(
    (event: ChangeEvent) => {
      const value: string = (event.target as HTMLInputElement).value;
      setMonitorInfo((prev) => ({ ...prev, body: value }));
    },
    [setMonitorInfo]
  );
...
export default memo(CreateHttpMonitor);
