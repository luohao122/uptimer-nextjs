      ...
      {monitor && (
        <div className="inline-flex shadow-sm" role="group">
          ...
          <Button
            ...
            className={clsx(
              "mr-1 inline-flex gap-2 items-center justify-center px-4 w-44 py-2 text-sm font-bold text-white rounded border hover:text-white",
              {
                "bg-green-400 border-green-400 hover:bg-green-400":
                  monitor.active,
                "bg-yellow-400 border-yellow-400 hover:bg-yellow-400":
                  !monitor.active,
              }
            )}
          />
