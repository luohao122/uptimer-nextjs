              ...
              .map((monitor: ISSLMonitorDocument, index: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 max-w-[250px] whitespace-nowrap text-ellipsis truncate">
                      {monitor.name}
                    </td>
                    <td
                    ...
                    <td className="px-6 py-5 max-w-[250px] whitespace-nowrap text-ellipsis truncate">
