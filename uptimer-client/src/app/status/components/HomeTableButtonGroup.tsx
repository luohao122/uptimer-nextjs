...
import { useHomeTableButtonGroup } from "../hooks/useHomeTableButtonGroup";

interface HomeTableButtonGroupProps {
  monitor: IMonitorDocument;
}

const HomeTableButtonGroup: FC<HomeTableButtonGroupProps> = ({
  monitor,
}): ReactElement => {
  const { toggleUserMonitor, editMonitor, deleteUserMonitor } =
    useHomeTableButtonGroup({ monitor });
...
export default memo(HomeTableButtonGroup);
