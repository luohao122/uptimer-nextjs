...
const Register: FC = (): ReactElement => {
  const { loading, setValidationErrors, validationErrors, onRegisterSubmit } =
    useRegister();
        ...
        <div className="mt-12 w-full px-5">
          ...
          <Fragment>
            ...
            {validationErrors!.email!.length > 0 && (
              <p className="mb-2 text-red-500">Invalid email</p>
            )}
          </Fragment>
          <Fragment>
            <label
          ...
          <Button
            ...
            label={`${loading ? "SUBMITTING..." : "CREATE FREE ACCOUNT"}`}
          />
        </div>
      </form>
      <div className="px-5">
